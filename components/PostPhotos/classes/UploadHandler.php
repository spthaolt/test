...
class UploadHandler
{
    ...
    protected function generate_unique_filename($filename = "") {
        ...
        return md5(uniqid().date('Y-m-d H:i:s:u')) . $extension;
    }

    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
            $index = null, $content_range = null) {
        $file = new \stdClass();
        $nameMd5 = $this->generate_unique_filename($name);
        $file->name = $this->get_file_name($uploaded_file, $nameMd5, $size, $type, $error,
            $index, $content_range);
